...
namespace Mind.Api.Attributes
{
    ...
    public class ValidateInfrastructureDeviceExistsAttribute : TypeFilterAttribute
    {
        ...
        /// 
        /// </summary>
        public ValidateInfrastructureDeviceExistsAttribute() : base(typeof(ValidateInfrastructureDeviceExistsActionFilter))
        {
        }
        ...
        private class ValidateInfrastructureDeviceExistsActionFilter : IAsyncActionFilter
        {
            ...
            {             
                ...
                {
                    context.ModelState.AddModelError(string.Empty, "Could not find the infrastructure device.");
