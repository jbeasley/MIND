...
{
    [ApiVersion("1.0")]
    public class TenantAttachmentSetOutboundPolicyIpNetworkController : BaseApiController
    {
        ...
        public TenantAttachmentSetOutboundPolicyIpNetworkController(IVpnTenantIpNetworkOutService vpnTenantIpNetworkOutService, IMapper mapper) : 
