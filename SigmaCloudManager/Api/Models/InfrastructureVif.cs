...
{ 
    /// <summary>
    /// Model of an infrastructure vif - a virtual attachment which is configured under am infrastructure tagged attachment
    /// </summary>
    [DataContract]
    public partial class InfrastructureVif : IEquatable<InfrastructureVif>
    { 
        /// <summary>
        /// The ID of the vif
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InfrastructureVif {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((InfrastructureVif)obj);
        }

        /// <summary>
        /// Returns true if InfrastructureVif instances are equal
        /// </summary>
        /// <param name="other">Instance of InfrastructureVif to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InfrastructureVif other)
        {
        ...
        public static bool operator ==(InfrastructureVif left, InfrastructureVif right)
        {
