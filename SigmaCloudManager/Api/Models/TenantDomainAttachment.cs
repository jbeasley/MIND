...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class TenantDomainAttachment : IEquatable<TenantDomainAttachment>
    { 
        /// <summary>
        ...
        [DataMember(Name="tenantDeviceName")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantDomainAttachment {\n");
            ...
            sb.Append("  TenantDevice: ").Append(TenantDeviceName).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TenantDomainAttachment)obj);
        }

        /// <summary>
        /// Returns true if TenantDomainAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of TenantDomainAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantDomainAttachment other)
        {
            ...
            return
                ...
                (
                    TenantDeviceName == other.TenantDeviceName ||
                    TenantDeviceName != null &&
                    TenantDeviceName.Equals(other.TenantDeviceName)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (TenantDeviceName != null)
                    hashCode = hashCode * 59 + TenantDeviceName.GetHashCode();
        ...
        public static bool operator ==(TenantDomainAttachment left, TenantDomainAttachment right)
        {
