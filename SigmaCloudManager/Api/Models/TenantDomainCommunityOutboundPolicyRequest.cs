...
{
    /// <summary>
    /// Model for requesting a tenant community association with the outbound policy a tenant domain device
    /// </summary>
    [DataContract]
    public partial class TenantDomainCommunityOutboundPolicyRequest : IEquatable<TenantDomainCommunityOutboundPolicyRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// An IPv4 BGP peer address from which the tenant community should be advertised. THe specified BGP peer must be configured and exist
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantDomainCommunityOutboundPolicyRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TenantDomainCommunityOutboundPolicyRequest)obj);
        }

        /// <summary>
        /// Returns true if TenantDomainCommunityOutboundPolicyRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of VpnTenantIpv4NetworkOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantDomainCommunityOutboundPolicyRequest other)
        {
        ...
        public static bool operator ==(TenantDomainCommunityOutboundPolicyRequest left, TenantDomainCommunityOutboundPolicyRequest right)
        {
