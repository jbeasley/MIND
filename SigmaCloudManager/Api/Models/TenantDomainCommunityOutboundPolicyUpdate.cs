...
{
    /// <summary>
    /// Model for updating a tenant community association with the outbound policy a tenant domain device
    /// </summary>
    [DataContract]
    public partial class TenantDomainCommunityOutboundPolicyUpdate : IEquatable<TenantDomainCommunityOutboundPolicyUpdate>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantDomainCommunityOutboundPolicyUpdate {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TenantDomainCommunityOutboundPolicyUpdate)obj);
        }

        /// <summary>
        /// Returns true if TenantDomainCommunityOutboundPolicyUpdate instances are equal
        /// </summary>
        /// <param name="other">Instance of VpnTenantIpv4NetworkOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantDomainCommunityOutboundPolicyUpdate other)
        {
        ...
        public static bool operator ==(TenantDomainCommunityOutboundPolicyUpdate left, TenantDomainCommunityOutboundPolicyUpdate right)
        {
