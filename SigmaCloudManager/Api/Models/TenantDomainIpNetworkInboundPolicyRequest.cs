...
{
    /// <summary>
    /// Model for requesting a tenant IP network association with the inbound policy of a bgp peer in the tenant domain
    /// </summary>
    [DataContract]
    public partial class TenantDomainIpNetworkInboundPolicyRequest : IEquatable<TenantDomainIpNetworkInboundPolicyRequest>
    {
        /// <summary>
        /// The ID of the tenant owner of the tenant IP network to be added to the BGP peer
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TenantDomainIpNetworkInboundPolicyRequest {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((TenantDomainIpNetworkInboundPolicyRequest)obj);
        }

        /// <summary>
        /// Returns true if TenantDomainIpNetworkInboundPolicyRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of TenantDomainIpNetworkInboundPolicyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TenantDomainIpNetworkInboundPolicyRequest other)
        {
        ...
        public static bool operator ==(TenantDomainIpNetworkInboundPolicyRequest left, TenantDomainIpNetworkInboundPolicyRequest right)
        {
