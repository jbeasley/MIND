...
{
    /// <summary>
    /// Model for requesting a tenant community association with the inbound policy of an attachment set
    /// </summary>
    [DataContract]
    public partial class VpnTenantCommunityInRequest : IEquatable<VpnTenantCommunityInRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Denotes whether the tenant community should be learned from all BGP peers that are configured within the attachment set. This property 
        ...
        /// <summary>
        /// The local IP routing preference to be applied to routes which are tagged with the tenant community.
        /// </summary>
            ...
            if (AddToAllBgpPeersInAttachmentSet.HasValue && AddToAllBgpPeersInAttachmentSet.Value)
                if (!string.IsNullOrEmpty(Ipv4PeerAddress))
                {
                    yield return new ValidationResult(
                        ...
                        "'false' in the request if you wish to associate the community with a specific BGP peer.");
                }
            ...
            if (AddToAllBgpPeersInAttachmentSet.HasValue && !AddToAllBgpPeersInAttachmentSet.Value)
                if (string.IsNullOrEmpty(Ipv4PeerAddress))
                {
                    yield return new ValidationResult(
                        ...
                        "the community should be associated with all BGP peers in the attachment set with the " +
        ...
        public override string ToString()
        {
            ...
            sb.Append("class VpnTenantCommunityInRequest {\n");
            sb.Append("  TenantId: ").Append(TenantId).Append("\n");
            sb.Append("  TenantCommunityName: ").Append(TenantCommunityName).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VpnTenantCommunityInRequest)obj);
        }

        /// <summary>
        /// Returns true if VpnTenantCommunityInRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of VpnTenantCommunityInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VpnTenantCommunityInRequest other)
        {
        ...
        public static bool operator ==(VpnTenantCommunityInRequest left, VpnTenantCommunityInRequest right)
        {
