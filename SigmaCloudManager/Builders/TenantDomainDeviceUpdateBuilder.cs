...
namespace Mind.Builders
{
    ...
    /// </summary>
    public class TenantDomainDeviceUpdateBuilder : TenantDomainDeviceBuilder, ITenantDomainDeviceUpdateBuilder
    {
        private readonly IPortUpdateDirector _portUpdateDirector;

        public TenantDomainDeviceUpdateBuilder(IUnitOfWork unitOfWork, IRoutingInstanceDirector routingInstanceDirector, 
        ...
        public ITenantDomainDeviceUpdateBuilder ForDevice(int? deviceId)
        {
            if (deviceId.HasValue) _args.Add(nameof(ForDevice), deviceId);
            return this;
        }

        ITenantDomainDeviceUpdateBuilder ITenantDomainDeviceUpdateBuilder.UseLayer2InterfaceMtu(bool? useLayer2InterfaceMtu)
        {
            base.UseLayer2InterfaceMtu(useLayer2InterfaceMtu);
            return this;
        }

        ITenantDomainDeviceUpdateBuilder ITenantDomainDeviceUpdateBuilder.WithDescription(string description)
        {
            base.WithDescription(description);
            return this;
        }

        ITenantDomainDeviceUpdateBuilder ITenantDomainDeviceUpdateBuilder.WithName(string name)
        {
            base.WithName(name);
            return this;
        }

        ITenantDomainDeviceUpdateBuilder ITenantDomainDeviceUpdateBuilder.WithStatus(string status)
        {
            base.WithStatus(status);
            return this;
        }

        public ITenantDomainDeviceUpdateBuilder WithPorts(List<PortUpdate> ports)
        {
