...
namespace Mind.Builders
{
    public class InfrastructureUntaggedBundleAttachmentDirector : IInfrastructureAttachmentDirector 
    {
        ...
        public InfrastructureUntaggedBundleAttachmentDirector(Func<InfrastructureAttachmentRequest, IBundleAttachmentBuilder> builderRequestFactory,
        ...
        public async Task<Attachment> UpdateAsync(Attachment attachment, InfrastructureAttachmentUpdate update)
        {
