...
{
    public class ProviderDomainIpNetworkOutboundPolicyUpdateDirector : IProviderDomainIpNetworkOutboundPolicyUpdateDirector
    {
        private readonly ITenantIpNetworkOutboundPolicyBuilder _builder;

        public ProviderDomainIpNetworkOutboundPolicyUpdateDirector(ITenantIpNetworkOutboundPolicyBuilder builder)
        {
            _builder = builder;
        }
