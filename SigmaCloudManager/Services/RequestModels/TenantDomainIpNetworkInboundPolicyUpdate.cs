...
{
    /// <summary>
    /// Model for updating a tenant IP network asociation with the inbound policy of a bgp peer in the tenant domain
    /// </summary>
    public class TenantDomainIpNetworkInboundPolicyUpdate
    {
        /// <summary>
