...
{
    public class InfrastructureAttachmentController : BaseViewController
    {
        private readonly IInfrastructureAttachmentService _attachmentService;
        public InfrastructureAttachmentController(IInfrastructureAttachmentService attachmentService, IUnitOfWork unitOfWork, IMapper mapper) :
        ...
        public async Task<IActionResult> Details(int? attachmentId)
        {
            ...
            return View(_mapper.Map<InfrastructureAttachmentViewModel>(item));
        }
        ...
        public async Task<IActionResult> GetAllByDeviceID(int? deviceId)
        {
            ...
            return View(_mapper.Map<List<InfrastructureAttachmentViewModel>>(attachments));
        }
        ...
        [ValidateInfrastructureDeviceExists]
        public async Task<IActionResult> Create(int? deviceId, InfrastructureAttachmentRequestViewModel requestModel)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    var request = _mapper.Map<InfrastructureAttachmentRequest>(requestModel);
        ...
        public async Task<ActionResult> Edit(int? attachmentId)
        {
            ...
            return View(_mapper.Map<InfrastructureAttachmentUpdateViewModel>(attachment));
        }

        [HttpPost]
        [ValidateInfrastructureAttachmentExists]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit(int? attachmentId, InfrastructureAttachmentUpdateViewModel update)
        {
            var attachment = await _attachmentService.GetByIDAsync(attachmentId.Value, deep: true, asTrackable: false);
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var attachmentUpdate = _mapper.Map<InfrastructureAttachmentUpdate>(update);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Delete(InfrastructureAttachmentDeleteViewModel model)
        {
