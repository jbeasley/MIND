...
{
    /// <summary>
    /// Model for updating a vif which belongs to an infrastructure attachment
    /// </summary>
    public class InfrastructureVifUpdateViewModel : IModifiableResource
    {
        public InfrastructureVifUpdateViewModel()
        {
