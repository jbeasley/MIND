...
{
    /// <summary>
    /// Model for updating an attachment within the tenant domain
    /// </summary>
    public class TenantDomainAttachmentUpdateViewModel : IModifiableResource
    {
        public TenantDomainAttachmentUpdateViewModel()
        {
        ...
        /// <summary>
        /// Optional parameters for updating the routing instance associated with the attachment.
        /// </summary>
