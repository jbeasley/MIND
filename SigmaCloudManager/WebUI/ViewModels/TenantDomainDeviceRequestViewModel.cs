...
{
    /// <summary>
    /// Model for requesting a new tenant domain device
    /// </summary>
    public class TenantDomainDeviceRequestViewModel
    {
        /// <summary>
        /// The ID of the tenant for which the new device will be allocated.
        /// </summary>
