...
namespace IO.NovaAttSwagger.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = IO.NovaAttSwagger.Client.Configuration.Default;
            RestClient = new RestClient("http://192.168.56.1:8080/restconf");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (http://192.168.56.1:8080/restconf).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? IO.NovaAttSwagger.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "http://192.168.56.1:8080/restconf")
        {
