...
namespace IO.NovaAttSwagger.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "http://192.168.56.1:8080/restconf";
        ...
        public Configuration(
            ...
            string basePath = "http://192.168.56.1:8080/restconf") : this()
        {
        ...
        {
            String report = "C# SDK (IO.NovaAttSwagger) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0.0.1\n";
