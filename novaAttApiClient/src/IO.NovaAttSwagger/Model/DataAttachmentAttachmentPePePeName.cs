...
{
    /// <summary>
    /// DataAttachmentAttachmentPePePeName
    /// </summary>
    [DataContract]
    public partial class DataAttachmentAttachmentPePePeName :  IEquatable<DataAttachmentAttachmentPePePeName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataAttachmentAttachmentPePePeName" /> class.
        /// </summary>
        /// <param name="attachmentpe">List of PE devices (list).</param>
        public DataAttachmentAttachmentPePePeName(List<DataAttachmentAttachmentPePepenameAttachmentpe> attachmentpe = default(List<DataAttachmentAttachmentPePepenameAttachmentpe>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataAttachmentAttachmentPePePeName {\n");
        ...
        {
            return this.Equals(input as DataAttachmentAttachmentPePePeName);
        }

        /// <summary>
        /// Returns true if DataAttachmentAttachmentPePePeName instances are equal
        /// </summary>
        /// <param name="input">Instance of DataAttachmentAttachmentPePePeName to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataAttachmentAttachmentPePePeName input)
        {
            if (input == null)
                return false;
