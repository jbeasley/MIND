...
${nuget_cmd} install src/IO.NovaVpnSwagger/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/IO.NovaVpnSwagger.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/IO.NovaVpnSwagger.dll \
-recurse:'src/IO.NovaVpnSwagger/*.cs' \
-doc:bin/IO.NovaVpnSwagger.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/IO.NovaVpnSwagger.dll was created successfully"
fi
