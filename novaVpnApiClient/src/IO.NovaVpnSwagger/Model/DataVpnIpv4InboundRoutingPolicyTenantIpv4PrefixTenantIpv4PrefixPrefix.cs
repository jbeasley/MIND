...
namespace IO.NovaVpnSwagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix :  IEquatable<DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix" /> class.
        /// </summary>
        /// <param name="vpntenantIpv4Prefix">List of IPv4 prefixes for routes towards Tenant Networks. (list).</param>
        public DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix(List<DataVpnIpv4inboundroutingpolicyTenantipv4prefixTenantipv4prefixprefixVpntenantipv4prefix> vpntenantIpv4Prefix = default(List<DataVpnIpv4inboundroutingpolicyTenantipv4prefixTenantipv4prefixprefixVpntenantipv4prefix>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix {\n");
        ...
        {
            return this.Equals(input as DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix);
        }

        /// <summary>
        /// Returns true if DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix instances are equal
        /// </summary>
        /// <param name="input">Instance of DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataVpnIpv4InboundRoutingPolicyTenantIpv4PrefixTenantIpv4PrefixPrefix input)
        {
            if (input == null)
                return false;
