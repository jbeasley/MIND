...
{
    /// <summary>
    /// Route-target &#39;A&#39;. If this VPN topology is Any-to-Any then this route-target is used for both import and export. If this VPN topology is Hub-and-Spoke then this route-target is used for export at hub VRFs and for import at spoke VRFs (non-presence)
    /// </summary>
    [DataContract]
    public partial class DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA :  IEquatable<DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA" /> class.
        /// </summary>
        ...
        public DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA(int? administratorSubfield = default(int?), int? assignedNumberSubfield = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA {\n");
        ...
        {
            return this.Equals(input as DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA);
        }

        /// <summary>
        /// Returns true if DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA instances are equal
        /// </summary>
        /// <param name="input">Instance of DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA input)
        {
            if (input == null)
                return false;
