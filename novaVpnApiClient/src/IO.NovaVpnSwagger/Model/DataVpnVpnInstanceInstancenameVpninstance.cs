...
{
    /// <summary>
    /// DataVpnVpnInstanceInstancenameVpninstance
    /// </summary>
    [DataContract]
    public partial class DataVpnVpnInstanceInstancenameVpninstance :  IEquatable<DataVpnVpnInstanceInstancenameVpninstance>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataVpnVpnInstanceInstancenameVpninstance" /> class.
        /// </summary>
        ...
        public DataVpnVpnInstanceInstancenameVpninstance(string name = default(string), ProtocolTypeEnum? protocolType = ProtocolTypeEnum.IP, List<DataVpnVpnInstanceInstancenameVpnattachmentsetVpnattachmentsetnameVpnvpnattachmentset> vpnAttachmentSet = default(List<DataVpnVpnInstanceInstancenameVpnattachmentsetVpnattachmentsetnameVpnvpnattachmentset>), AddressFamilyEnum? addressFamily = AddressFamilyEnum.IPv4, TopologyTypeEnum? topologyType = TopologyTypeEnum.AnyToAny, string isExtranet = default(string), DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA routeTargetA = default(DataVpnVpnInstanceInstancenameRoutetargetAVpnroutetargetA), DataVpnVpnInstanceInstancenameRoutetargetBVpnroutetargetB routeTargetB = default(DataVpnVpnInstanceInstancenameRoutetargetBVpnroutetargetB))
        {
            this.Name = name;
        ...
        public List<DataVpnVpnInstanceInstancenameVpnattachmentsetVpnattachmentsetnameVpnvpnattachmentset> VpnAttachmentSet { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataVpnVpnInstanceInstancenameVpninstance {\n");
        ...
        {
            return this.Equals(input as DataVpnVpnInstanceInstancenameVpninstance);
        }

        /// <summary>
        /// Returns true if DataVpnVpnInstanceInstancenameVpninstance instances are equal
        /// </summary>
        /// <param name="input">Instance of DataVpnVpnInstanceInstancenameVpninstance to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataVpnVpnInstanceInstancenameVpninstance input)
        {
            if (input == null)
                return false;
